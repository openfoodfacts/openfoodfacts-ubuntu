...
<title>~michael-sheldon/podbird/trunk : contents of app/welcomewizard/Slide4.qml at revision 147</title>
...
/<a href="/~michael-sheldon/podbird/trunk/files/147/app">app</a>/<a href="/~michael-sheldon/podbird/trunk/files/147/app/welcomewizard">welcomewizard</a>/Slide4.qml
...
<li>
<a href="/~michael-sheldon/podbird/trunk/annotate/head:/app/welcomewizard/Slide4.qml">view with revision information</a>
</li>
...
<li>
<a href="/~michael-sheldon/podbird/trunk/changes?filter_file_id=slide4.qml-20150329224110-n1jx9834etj35c1l-13">view changes to this file</a>
</li>
<li id="last">
<a href="/~michael-sheldon/podbird/trunk/download/head:/slide4.qml-20150329224110-n1jx9834etj35c1l-13/Slide4.qml">download file</a>
</li>
</ul>
<div class="view">
<table id="logentries">
...
<span class="pyg-c1">// Slide 4</span>
<span class="pyg-nx">Component</span> <span class="pyg-p">{</span>
    <span class="pyg-kd">id: slide4</span>
    <span class="pyg-nx">Item</span> <span class="pyg-p">{</span>
        ...
        <span class="pyg-nx">Image</span> <span class="pyg-p">{</span>
            ...
            <span class="pyg-k">source:</span> <span class="pyg-nx">Qt</span><span class="pyg-p">.</span><span class="pyg-nx">resolvedUrl</span><span class="pyg-p">(</span><span class="pyg-s2">&quot;../graphics/language.png&quot;</span><span class="pyg-p">)</span>
        <span class="pyg-p">}</span>
        ...
        <span class="pyg-nx">Label</span> <span class="pyg-p">{</span>
            ...
            <span class="pyg-c1">// TRANSLATORS: This text should be in a language different from the language set by the user.</span>
            <span class="pyg-c1">// For instance, if the app was in english, then it is appropriate to set this string as</span>
            <span class="pyg-c1">// Hallo or Bonjour etc to symbolize the internationalization feature in podbird.</span>
            <span class="pyg-k">text:</span> <span class="pyg-nx">i18n</span><span class="pyg-p">.</span><span class="pyg-nx">tr</span><span class="pyg-p">(</span><span class="pyg-s2">&quot;Hallo! Bonjour!&quot;</span><span class="pyg-p">)</span>
        ...
        <span class="pyg-nx">Label</span> <span class="pyg-p">{</span>
            ...
            <span class="pyg-k">text:</span> <span class="pyg-nx">i18n</span><span class="pyg-p">.</span><span class="pyg-nx">tr</span><span class="pyg-p">(</span><span class="pyg-s2">&quot;Podbird is available in over 15 languages and is translated by the %1 community&quot;</span><span class="pyg-p">).</span><span class="pyg-nx">arg</span><span class="pyg-p">(</span><span class="pyg-s2">&quot;&lt;a href=\&quot;http://community.ubuntu.com/contribute/translations\&quot;&gt;Ubuntu Translators&lt;/a&gt;&quot;</span><span class="pyg-p">)</span>
