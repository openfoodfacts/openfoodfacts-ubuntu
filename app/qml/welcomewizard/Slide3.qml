...
<title>~michael-sheldon/podbird/trunk : contents of app/welcomewizard/Slide3.qml at revision 147</title>
...
/<a href="/~michael-sheldon/podbird/trunk/files/147/app">app</a>/<a href="/~michael-sheldon/podbird/trunk/files/147/app/welcomewizard">welcomewizard</a>/Slide3.qml
...
<li>
<a href="/~michael-sheldon/podbird/trunk/annotate/head:/app/welcomewizard/Slide3.qml">view with revision information</a>
</li>
...
<li>
<a href="/~michael-sheldon/podbird/trunk/changes?filter_file_id=slide3.qml-20150329224110-n1jx9834etj35c1l-12">view changes to this file</a>
</li>
<li id="last">
<a href="/~michael-sheldon/podbird/trunk/download/head:/slide3.qml-20150329224110-n1jx9834etj35c1l-12/Slide3.qml">download file</a>
</li>
</ul>
<div class="view">
<table id="logentries">
...
<span class="pyg-c1">// Slide 3</span>
<span class="pyg-nx">Component</span> <span class="pyg-p">{</span>
    <span class="pyg-kd">id: slide3</span>
    <span class="pyg-nx">Item</span> <span class="pyg-p">{</span>
        ...
        <span class="pyg-nx">Image</span> <span class="pyg-p">{</span>
            ...
            <span class="pyg-k">source:</span> <span class="pyg-nx">Qt</span><span class="pyg-p">.</span><span class="pyg-nx">resolvedUrl</span><span class="pyg-p">(</span><span class="pyg-s2">&quot;../graphics/smart.png&quot;</span><span class="pyg-p">)</span>
        <span class="pyg-p">}</span>
        ...
        <span class="pyg-nx">Label</span> <span class="pyg-p">{</span>
            ...
            <span class="pyg-k">text:</span> <span class="pyg-nx">i18n</span><span class="pyg-p">.</span><span class="pyg-nx">tr</span><span class="pyg-p">(</span><span class="pyg-s2">&quot;Smart Settings&quot;</span><span class="pyg-p">)</span>
        ...
        <span class="pyg-nx">Label</span> <span class="pyg-p">{</span>
            ...
            <span class="pyg-p">}</span>
            <span class="pyg-k">horizontalAlignment:</span> <span class="pyg-nx">Text</span><span class="pyg-p">.</span><span class="pyg-nx">AlignHCenter</span>
            <span class="pyg-k">text:</span> <span class="pyg-nx">i18n</span><span class="pyg-p">.</span><span class="pyg-nx">tr</span><span class="pyg-p">(</span><span class="pyg-s2">&quot;Podbird can optionally download new episodes and clean up old episodes automatically, this \</span>
<span class="pyg-s2">can be enabled from the settings page.&quot;</span><span class="pyg-p">)</span>
            <span class="pyg-k">wrapMode:</span> <span class="pyg-nx">Text</span><span class="pyg-p">.</span><span class="pyg-nx">WordWrap</span>
        <span class="pyg-p">}</span>
    <span class="pyg-p">}</span>
<span class="pyg-p">}</span>
