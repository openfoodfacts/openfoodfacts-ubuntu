...
<title>~michael-sheldon/podbird/trunk : contents of app/welcomewizard/Slide1.qml at revision 147</title>
...
/<a href="/~michael-sheldon/podbird/trunk/files/147/app">app</a>/<a href="/~michael-sheldon/podbird/trunk/files/147/app/welcomewizard">welcomewizard</a>/Slide1.qml
...
<li>
<a href="/~michael-sheldon/podbird/trunk/annotate/head:/app/welcomewizard/Slide1.qml">view with revision information</a>
</li>
...
<li>
<a href="/~michael-sheldon/podbird/trunk/changes?filter_file_id=slide1.qml-20150329224110-n1jx9834etj35c1l-10">view changes to this file</a>
</li>
<li id="last">
<a href="/~michael-sheldon/podbird/trunk/download/head:/slide1.qml-20150329224110-n1jx9834etj35c1l-10/Slide1.qml">download file</a>
</li>
</ul>
<div class="view">
<table id="logentries">
...
<span class="pyg-c1">// Slide 1</span>
<span class="pyg-nx">Component</span> <span class="pyg-p">{</span>
    <span class="pyg-kd">id: slide1</span>
    <span class="pyg-nx">Item</span> <span class="pyg-p">{</span>
        ...
        <span class="pyg-nx">Image</span> <span class="pyg-p">{</span>
            ...
            <span class="pyg-k">source:</span> <span class="pyg-nx">Qt</span><span class="pyg-p">.</span><span class="pyg-nx">resolvedUrl</span><span class="pyg-p">(</span><span class="pyg-s2">&quot;../graphics/podbird.png&quot;</span><span class="pyg-p">)</span>
            ...
            <span class="pyg-k">antialiasing:</span> <span class="pyg-kc">true</span>
        <span class="pyg-p">}</span>

        <span class="pyg-nx">Label</span> <span class="pyg-p">{</span>
            <span class="pyg-kd">id: introductionText</span>
            <span class="pyg-k">text:</span> <span class="pyg-nx">i18n</span><span class="pyg-p">.</span><span class="pyg-nx">tr</span><span class="pyg-p">(</span><span class="pyg-s2">&quot;Welcome to Podbird&quot;</span><span class="pyg-p">)</span>
            <span class="pyg-k">fontSize:</span> <span class="pyg-s2">&quot;x-large&quot;</span>
            <span class="pyg-k">height:</span> <span class="pyg-nx">contentHeight</span>
            <span class="pyg-k">anchors.centerIn:</span> <span class="pyg-nx">parent</span>
        <span class="pyg-p">}</span>

        <span class="pyg-nx">Label</span> <span class="pyg-p">{</span>
            <span class="pyg-kd">id: bodyText</span>
            <span class="pyg-k">text:</span> <span class="pyg-nx">i18n</span><span class="pyg-p">.</span><span class="pyg-nx">tr</span><span class="pyg-p">(</span><span class="pyg-s2">&quot;Enjoy your favourite shows with Podbird, the chirpiest podcast \</span>
<span class="pyg-s2">manager for Ubuntu.\n\nChirp Chirp...&quot;</span><span class="pyg-p">)</span>
            <span class="pyg-k">anchors.left:</span> <span class="pyg-nx">parent</span><span class="pyg-p">.</span><span class="pyg-nx">left</span>
            <span class="pyg-k">anchors.right:</span> <span class="pyg-nx">parent</span><span class="pyg-p">.</span><span class="pyg-nx">right</span>
            <span class="pyg-k">anchors.margins:</span> <span class="pyg-nx">units</span><span class="pyg-p">.</span><span class="pyg-nx">gu</span><span class="pyg-p">(</span><span class="pyg-mi">1</span><span class="pyg-p">)</span>
            <span class="pyg-k">anchors.top:</span> <span class="pyg-nx">introductionText</span><span class="pyg-p">.</span><span class="pyg-nx">bottom</span>
            <span class="pyg-k">anchors.topMargin:</span> <span class="pyg-nx">units</span><span class="pyg-p">.</span><span class="pyg-nx">gu</span><span class="pyg-p">(</span><span class="pyg-mi">4</span><span class="pyg-p">)</span>
            <span class="pyg-k">anchors.bottom:</span> <span class="pyg-nx">swipeText</span><span class="pyg-p">.</span><span class="pyg-nx">top</span>
        ...
        <span class="pyg-nx">Label</span> <span class="pyg-p">{</span>
            <span class="pyg-kd">id: swipeText</span>
            <span class="pyg-k">anchors.left:</span> <span class="pyg-nx">parent</span><span class="pyg-p">.</span><span class="pyg-nx">left</span>
            <span class="pyg-k">anchors.right:</span> <span class="pyg-nx">parent</span><span class="pyg-p">.</span><span class="pyg-nx">right</span>
            <span class="pyg-k">anchors.margins:</span> <span class="pyg-nx">units</span><span class="pyg-p">.</span><span class="pyg-nx">gu</span><span class="pyg-p">(</span><span class="pyg-mi">1</span><span class="pyg-p">)</span>
            <span class="pyg-k">anchors.bottom:</span> <span class="pyg-nx">parent</span><span class="pyg-p">.</span><span class="pyg-nx">bottom</span>
            <span class="pyg-k">color:</span> <span class="pyg-s2">&quot;grey&quot;</span>
            <span class="pyg-k">fontSize:</span> <span class="pyg-s2">&quot;small&quot;</span>
            <span class="pyg-k">wrapMode:</span> <span class="pyg-nx">Text</span><span class="pyg-p">.</span><span class="pyg-nx">WordWrap</span>
            <span class="pyg-k">horizontalAlignment:</span> <span class="pyg-nx">Text</span><span class="pyg-p">.</span><span class="pyg-nx">AlignHCenter</span>
            <span class="pyg-k">text:</span> <span class="pyg-nx">i18n</span><span class="pyg-p">.</span><span class="pyg-nx">tr</span><span class="pyg-p">(</span><span class="pyg-s2">&quot;Swipe to move between pages&quot;</span><span class="pyg-p">)</span>
