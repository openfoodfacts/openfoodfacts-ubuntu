...
<title>~michael-sheldon/podbird/trunk : contents of app/welcomewizard/Slide6.qml at revision 147</title>
...
/<a href="/~michael-sheldon/podbird/trunk/files/147/app">app</a>/<a href="/~michael-sheldon/podbird/trunk/files/147/app/welcomewizard">welcomewizard</a>/Slide6.qml
...
<li>
<a href="/~michael-sheldon/podbird/trunk/annotate/head:/app/welcomewizard/Slide6.qml">view with revision information</a>
</li>
...
<li>
<a href="/~michael-sheldon/podbird/trunk/changes?filter_file_id=slide6.qml-20150329224110-n1jx9834etj35c1l-15">view changes to this file</a>
</li>
<li id="last">
<a href="/~michael-sheldon/podbird/trunk/download/head:/slide6.qml-20150329224110-n1jx9834etj35c1l-15/Slide6.qml">download file</a>
</li>
</ul>
<div class="view">
<table id="logentries">
...
<span class="pyg-c1">// Slide 6</span>
<span class="pyg-nx">Component</span> <span class="pyg-p">{</span>
    <span class="pyg-kd">id: slide6</span>
    <span class="pyg-nx">Item</span> <span class="pyg-p">{</span>
        ...
        <span class="pyg-nx">Image</span> <span class="pyg-p">{</span>
            ...
            <span class="pyg-k">source:</span> <span class="pyg-nx">Qt</span><span class="pyg-p">.</span><span class="pyg-nx">resolvedUrl</span><span class="pyg-p">(</span><span class="pyg-s2">&quot;../graphics/gift.png&quot;</span><span class="pyg-p">)</span>
        <span class="pyg-p">}</span>
        ...
        <span class="pyg-nx">Label</span> <span class="pyg-p">{</span>
            ...
            <span class="pyg-k">text:</span> <span class="pyg-nx">i18n</span><span class="pyg-p">.</span><span class="pyg-nx">tr</span><span class="pyg-p">(</span><span class="pyg-s2">&quot;Enjoy&quot;</span><span class="pyg-p">)</span>
        ...
        <span class="pyg-nx">Label</span> <span class="pyg-p">{</span>
            ...
            <span class="pyg-nx">anchors</span> <span class="pyg-p">{</span>
                ...
                <span class="pyg-k">bottom:</span> <span class="pyg-nx">continueButton</span><span class="pyg-p">.</span><span class="pyg-nx">top</span>
            ...
            <span class="pyg-p">}</span>
            <span class="pyg-k">horizontalAlignment:</span> <span class="pyg-nx">Text</span><span class="pyg-p">.</span><span class="pyg-nx">AlignHCenter</span>
            <span class="pyg-k">text:</span> <span class="pyg-nx">i18n</span><span class="pyg-p">.</span><span class="pyg-nx">tr</span><span class="pyg-p">(</span><span class="pyg-s2">&quot;We hope you enjoy using Podbird!&quot;</span><span class="pyg-p">)</span>
            <span class="pyg-k">wrapMode:</span> <span class="pyg-nx">Text</span><span class="pyg-p">.</span><span class="pyg-nx">WordWrap</span>
        <span class="pyg-p">}</span>

        <span class="pyg-nx">Button</span> <span class="pyg-p">{</span>
            <span class="pyg-kd">id: continueButton</span>
            <span class="pyg-nx">anchors</span> <span class="pyg-p">{</span>
                <span class="pyg-k">bottom:</span> <span class="pyg-nx">parent</span><span class="pyg-p">.</span><span class="pyg-nx">bottom</span>
                <span class="pyg-k">bottomMargin:</span> <span class="pyg-nx">units</span><span class="pyg-p">.</span><span class="pyg-nx">gu</span><span class="pyg-p">(</span><span class="pyg-mi">3</span><span class="pyg-p">)</span>
                <span class="pyg-k">horizontalCenter:</span> <span class="pyg-nx">parent</span><span class="pyg-p">.</span><span class="pyg-nx">horizontalCenter</span>
            <span class="pyg-p">}</span>
            <span class="pyg-k">height:</span> <span class="pyg-nx">units</span><span class="pyg-p">.</span><span class="pyg-nx">gu</span><span class="pyg-p">(</span><span class="pyg-mi">6</span><span class="pyg-p">)</span>
            <span class="pyg-k">width:</span> <span class="pyg-nx">parent</span><span class="pyg-p">.</span><span class="pyg-nx">width</span><span class="pyg-o">/</span><span class="pyg-mf">1.3</span>
            <span class="pyg-k">color:</span> <span class="pyg-nx">UbuntuColors</span><span class="pyg-p">.</span><span class="pyg-nx">green</span>
            <span class="pyg-k">text:</span> <span class="pyg-nx">i18n</span><span class="pyg-p">.</span><span class="pyg-nx">tr</span><span class="pyg-p">(</span><span class="pyg-s2">&quot;Finish&quot;</span><span class="pyg-p">)</span>
            <span class="pyg-k">onClicked:</span> <span class="pyg-nx">finished</span><span class="pyg-p">()</span>
        <span class="pyg-p">}</span>
    <span class="pyg-p">}</span>
<span class="pyg-p">}</span>
</pre>
